...
fn icon_button(icon_name: &str, label: &str, onclick: Callback<MouseEvent>) -> Html {
    html! {
        ...
        html! {
                    <div>
                        ...
                        <div class="icon-toolbar">
                            {icon_button("text_fields", "Normal", link.callback(|_| Msg::ApplyStyle("normal".to_string())))}
                            {icon_button("format_bold", "Negrita", link.callback(|_| Msg::ApplyStyle("bold".to_string())))}
                            {icon_button("format_italic", "Cursiva", link.callback(|_| Msg::ApplyStyle("italic".to_string())))}
                            {icon_button("format_bold", "Negrita+Cursiva", link.callback(|_| Msg::ApplyStyle("bolditalic".to_string())))}
                        </div>
                        <div class="tab-bar">
                            <button
